...
from ..graph_loader import GAMES, GG, NODES
    ...
    def run(self, params):
        ...
        bar = {
            ...
            "data": {
                ...
                "series": [
                    {"name": "规模", "color": "#f5b301", "values": [p["size"] for p in profs]}
                ],
                "horizontal": False,
            },
        }
        ...
        metrics = {"method": params["method"], "n_communities": len(profs), "quality": info}
